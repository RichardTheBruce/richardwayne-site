...
4. **BC ERA thread.** Carlo's retainer posting ($100-150/hr systems architect) is still the single largest open opportunity in the pipeline. The new site strengthens that pitch directly: send him the AFI + Memetropolis case studies once live.
